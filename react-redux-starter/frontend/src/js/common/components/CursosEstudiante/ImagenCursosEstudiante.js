...
const Imagen=(props)=>{
    const {portada, curso, color,nombre_profesor , apellido_profesor, asignacion} = props;
    return(
        <React.Fragment>
            <div className="col-12 col-sm-6 col-md-4 col-lg-4 mb-4">
                <div className="card">
                    ...
                    <center><a className={`circle-tile-footer ${color}`}  href={`/#/DetalleCursoEstudiante/${asignacion}/${curso}`}>Ver Mas  <i className="fa fa-chevron-circle-right"></i></a></center>
                </div>
            </div>
        </React.Fragment>
    )
