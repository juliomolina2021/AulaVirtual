...
/***************************** */
const GUARDAR_REGISTRO_ROL_USUARIO='GUARDAR_REGISTRO_ROL_USUARIO'
...
export const getMe = () => (dispatch) => {
    api.get('/user/me').then(me => {
        dispatch({type:GUARDAR_REGISTRO_ROL_USUARIO, rol_usuario:me});
    }).catch((error)=>{
        console.log("error: ", error);
        NotificationManager.error(
...
export const reducers = {
    ...
    [GUARDAR_REGISTRO_ROL_USUARIO]: (state, { rol_usuario } )=> {
        return {
            ...state,
            rol_usuario,
        };
